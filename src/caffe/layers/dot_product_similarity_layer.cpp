...
void DotProductSimilarityLayer<Dtype>::SetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top) {
// TODO: to edit it
  CHECK_EQ(bottom.size(), 1) << "Dot-Product Similarity Layer takes a single blob as input.";
  CHECK_EQ(top->size(), 1) << "Dot-Product Similarity Layer takes a single blob as output.";
...
template <typename Dtype>
Dtype DotProductSimilarityLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    vector<Blob<Dtype>*>* top) {
// TODO: 
